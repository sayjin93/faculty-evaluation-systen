...
db.community_services.belongsTo(db.academic_years, { foreignKey: "academic_year_id" });

db.scientific_works.belongsTo(db.academic_years, { foreignKey: "academic_year_id" });
...
db.conferences.belongsTo(db.scientific_works, { foreignKey: "scientific_work_id" });
